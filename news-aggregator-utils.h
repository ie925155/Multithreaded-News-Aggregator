...
#ifndef _news_aggregator_utils_
#define _news_aggregator_utils_
#include <string>

/**
 * Function: getURLServer
 * ----------------------
 * Given a bonafide URL server string (e.g. "http://cs110.stanford.edu", or
